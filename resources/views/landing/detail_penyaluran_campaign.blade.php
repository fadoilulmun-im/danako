        ...
        <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="job-details-text">
                            ...
                            <img src="{{ asset('') }}danako/img/campaign/detail-campaign2.png" class="img-fluid" alt="Responsive image">
            ...
            <div class="col-lg-4">
                ...
                <div class="job-sidebar">
                    <h3>Total dana tersalurkan: <span class="color-primary">Rp 34.567.890</span></h3>
                    <div class="card" style="height: 500px; overflow-y: scroll;">
                        <div class="card-body">

                          <div class="card-text border-start">
                            <h4 class="text-start">Pencairan Dana Rp 1.500.000</h4>
                            <h6 class="text-start">Ke rekening *****1334124521 a.n. SITI</h6>
                            <h6 class="text-start">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc sem nulla, elementum in diam sit amet, hen Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc sem nulla, elementum in diam sit amet, hen</h6>
                            <p class="text-end">2022-02-30 11:46:30</p>
                          </div>
